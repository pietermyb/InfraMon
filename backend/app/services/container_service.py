...
class ContainerService:
    ...
    async def list_containers(self, all_containers: bool = False, group_id: Optional[int] = None) -> List[Container]:
    ...
    async def update_group(self, group_id: int, group_data: ContainerGroupUpdate) -> Optional[ContainerGroup]:
