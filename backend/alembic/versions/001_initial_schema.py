...
def upgrade() -> None:
    ...
    op.create_index('ix_docker_compose_projects_id', 'docker_compose_projects', ['id'], unique=False)
    op.create_index('ix_docker_compose_projects_project_name', 'docker_compose_projects', ['project_name'], unique=False)
    ...
    op.create_index('ix_container_stats_container_id', 'container_stats', ['container_id'], unique=False)
